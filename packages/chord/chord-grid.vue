...
import { Grid, Boxes, OctaveSelector, Selector, LamplightIcon } from "./components";
import { type NoteInChord, playNotes, NOTES, coords2level, useUnifiedChord } from "./utils";
  ...
  <div class="flex flex-col items-center m-8 chord-grid">
    ...
    <div class="flex items-center gap-2 mt-4">
      ...
      <input
        ...
        readonly
      />
      <OctaveSelector v-model="selectedRootCoord.w" />
      <Selector @change="handleChordChange" />
      <button
        @click="muted = !muted"
    ...
    <div class="m-8 w-full">
      ...
      <ol>
        <li>
          「零维」<LamplightIcon class="inline-flex!" />是纯一度（一倍音）
        </li>
        <li>
          「一维」<LamplightIcon
            class="inline-flex!"
